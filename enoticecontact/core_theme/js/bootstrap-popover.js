...
!function( $ ) {
 ...
 "use strict"
  ...
  var Popover2 = function ( element, options ) {
  ...
  Popover2.prototype = $.extend({}, $.fn.tooltip.Constructor.prototype, {

    constructor: Popover2
  ...
  * ======================= */
  ...
  $.fn.popover2 = function ( option ) {
    return this.each(function () {
      var $this = $(this)
        , data = $this.data('popover2')
        , options = typeof option == 'object' && option
      if (!data) $this.data('popover2', (data = new Popover2(this, options)))
      if (typeof option == 'string') data[option]()
    })
  }

  $.fn.popover2.Constructor = Popover2

  $.fn.popover2.defaults = $.extend({} , $.fn.tooltip.defaults, {
    placement: 'right'
  , content: ''
