...
(function($) {
  ...
  Confirmation.DEFAULTS = $.extend({}, $.fn.popover2.Constructor.DEFAULTS, {
    placement: 'top',
    title: 'Are you sure?',
    popout: false,
    singleton: false,
  ...
  Confirmation.prototype = $.extend({}, $.fn.popover2.Constructor.prototype);
  ...
  Confirmation.prototype.init = function(element, options) {
    $.fn.popover2.Constructor.prototype.init.call(this, 'confirmation', element, options);
