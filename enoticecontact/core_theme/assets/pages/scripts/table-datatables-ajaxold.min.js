var TableDatatablesAjax=function(){
    ...
    e=function(){
        ...
        dataTable:{bStateSave:!0,lengthMenu:[[10,20,50,100,150,-1],[10,20,50,100,150,"All"]],pageLength:10,ajax:{url:""},order:[[1,"asc"]]}}),
        a.getTableWrapper().on("click",".table-group-action-submit",function(e){
            ...
            a.clearAjaxParams()):""==t.val()?App.alert({type:"danger",
            icon:"warning",
            message:"Please select an action",
            container:a.getTableWrapper(),
            place:"prepend"}):0===a.getSelectedRowsCount()&&App.alert({
                type:"danger",
            icon:"warning",
            ...
            a.setAjaxParam("action","data"),
            a.getDataTable().ajax.reload(),
            a.clearAjaxParams()};
        return{init:function(){a(),e()}}}();jQuery(document).ready(function(){TableDatatablesAjax.init()});