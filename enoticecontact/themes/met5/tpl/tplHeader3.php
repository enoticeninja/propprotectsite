...
<!-- BEGIN: Header -->
<header class="m-grid__item    m-header animated slideInDown faster" data-minimize-offset="200" data-minimize-mobile-offset="200" id="main-header">
                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    <div class="m-stack__item m-stack__item--middle m-stack__item--center m-brand__logo">
                        <a href="<?php echo SITE_PATH ?>DashBoard" class="m-brand__logo-wrapper">
							<img alt="" class="img-fluid" src="<?php echo get_core_theme_path() ?>images/logo-backend.png"/>
						</a>
                    </div>
                                                ...
                                                <div class="m-list-search__form-wrapper">
                                                    <span class="m-list-search__form-input-wrapper">
                                                        <input id="m_quicksearch_input" autocomplete="off"
                                                            type="text" name="q" class="m-list-search__form-input"
                                ...
                                <div class="m-dropdown__wrapper">
                                    ...
                                    <div class="m-dropdown__inner">
                                        <div class="m-dropdown__header m--align-center"
                                            style="background: url(<?php echo HTTP_THEME_PATH ?>assets/app/media/img/misc/quick_actions_bg.jpg); background-size: cover;">
                                            <span class="m-dropdown__header-title">
                                                Quick Actions
                                            </span>
                                            <span class="m-dropdown__header-subtitle">
										...
										<div class="m-dropdown__body">
											<div class="m-dropdown__content">
												<ul class="m-nav m-nav--skin-light">
													...
													<?php if(USER_LEVEL == 'adminasdasdasdasdas') { ?>
