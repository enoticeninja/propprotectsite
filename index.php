...
<html>
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-12">
			    ...
			    <div class="subscribe">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                            <div class="quarterly-plan">
                                <h3><span class="rupee">&#8377;.</span> 3650 </h3>
			    <!--    <h6>• Yearly Subscription Price• </h6>   -->
                                <h6> Yearly Price </h6>
                                <p>Daily View + Unlimited Property Search</p>
                            </div>
                            <div class="subscribe">
                            </div>
                        </div>
	...
	<!--		<div class="row">  -->
                         ...
                         <!--       <div class="alert-plan">  -->
                               <div class="quarterly-plan">
                                        <h3><span class="rupee">&#8377;.</span> 699 </h3>
                                       <!-- <h6>• Yearly per Property • </h6>  -->
                                        <h6>Yearly per Property </h6>
                                        <p>Alerts for Properties</p>
                                    </div>
                                    <div class="subscribe">
                                    </div>
                                </div>
