			...
			<div class="row">
                            <!--<div class="col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="about-caption-1">
                                    <h3>370,000<span class="plus-sign">&plus;</span></h3>
                                    <h4>Notices</h4>
                                    <p>Property notices and growing</p>
                                </div>
                            </div>
			-->
                            <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="about-caption-1">
                                    <h3>100<span class="plus-sign">&plus;</span></h3>
                                    <h4>News Papers</h4>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="about-caption-1 last-brder">
                                    <h3>30 <span class="plus-sign">&plus;</span></h3>
                                    <h4>Cities</h4>
                                    <p>Get property notices from 30+ cities. More cities will be added soon.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--
        <div id="marketing_partner" class="connect">
           <div class="container">
	       <div class="row">
		   <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <h6>MARKETING PARTNER</h6>
                          <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                             <img class="w-50 d-none d-sm-block" src="images/marketingpartner-1.jpg" alt="Managing Partner" height="100" width="100">
 			     <p>Orange Advertising & Marketing</p>
...
<table style="height: 100%;
	...
	<p> <p><b><h3>MARKETING PARTNER</h3></b></p> 
	    <img src="images/marketingpartner-1.jpg" width=140 height=140 />
	    <p><h8>Orange Advertising & Marketing</h8></p>
	</p>
        </td>
    </tr>
</table>
