        ...
        <div id="about" class="about">
            <div class="container">
                <div class="about-caption">
                    <h2>All Newspapers, All Property Notices, On One App, It’s That Simple</h2>
                    <div class="about-1">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="about-caption-1">
                                    ...
                                    <h4>Daily Notices</h4>
                                    <p>Get all property notices on one platform.</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="about-caption-1">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            ...
                            <div class="search-plus-1">
                                ...
                                <div class="arrow-caption">
                                    <p>With one click, view all daily public property notices published in all newspapers region in one go.</p>
                                </div>
                            </div>
                            <div class="search-plus-1">
                                <div class="arrow-image">
                    ...
                    <div class="plan-details-2">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="alert-plan">
                                    <div class="quarterly-plan">
                                        <h3><span class="rupee">&#8377;.</span> 549</h3>
                                        <h6>Yearly • Per Property</h6>
                                        <p>Set Alerts for up to 5<br>Properties</p>
                                    </div>
                                    <div class="subscribe">
                                        <!--<a href="http://nanostuffs.com/enotice/login.php" target="_blank">
								<a href="#download"><button class="btn-subscribe">SUBSCRIBE NOW</button></a>-->
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="alert-plan">
                                    <div class="quarterly-plan">
                                        <h3><span class="rupee">&#8377;.</span> 399</h3>
                                        <h6>Yearly • Per Property</h6>
                                        <p>Set Alerts for 6+ up to 9<br>Properties</p>
                                    </div>
                                    <div class="subscribe">
                                        <!--<a href="http://nanostuffs.com/enotice/login.php" target="_blank">
								<a href="#download"><button class="btn-subscribe">SUBSCRIBE NOW</button></a>-->
